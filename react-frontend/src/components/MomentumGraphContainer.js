...
function MomentumGraphContainer (props) {
    ...
    //console.log(props.RSIparameters)
    const TSIparameters = {'displayTSI':props.displayTSI,'rTSI':props.rForTSI,'sTSI':props.sForTSI}
    console.log(props.loads)
    //console.log('DIsplay TSI', props.displayTSI)
    //console.log(JSON.stringify([props.stockData,RSIparameters,TSIparameters]))
    // if (props.stockData.length > 1 && RSIparameters != 'undefined' && TSIparameters != 'undefined' ) {
    ...
    // console.log(props.stockData.length)
    // console.log(props.momentumData)
    // if (props.momentumData != 'undefined' || props.stockData.length > 1) {
        function createMomentumIndicatorsChart(momentumIndicatorsChartNode) {
            var data = props.stockData
            console.log(data)
            if (props.momentumData != 'undefined'){
                data = props.momentumData
            }
    ...
    //     return props.momentumData.loading ? (


    //         <h2>Loading</h2>
    //             ) : props.momentumData.error ? (
    //                 <h2>{props.momentumData.error}</h2>
    //             ) : (
    //         <div>
    //             <React.Fragment>
