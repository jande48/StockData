...
import { nForStochSignal, dnForStochSignal } from '../../../redux'
import { Grid, Menu, Form, Select} from "semantic-ui-react"

function STOCHSIGNALcontentPanel(props) {
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    onChange ={(e,selectedOption) => {
                        props.nForSTOCHSIGNALdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
        <Grid.Row>
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    compact
                    onChange ={(e,selectedOption) => {
                        props.dnForSTOCHSIGNALdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
...
const mapDispatchToProps = dispatch => {
  return {
    nForSTOCHSIGNALdispatch: x => dispatch(nForStochSignal(x)),
    dnForSTOCHSIGNALdispatch: x => dispatch(dnForStochSignal(x)),
  }
}
