...
import { nForSTOCH, dnForSTOCH } from '../../../redux'
import { Grid, Menu, Form, Select} from "semantic-ui-react"

function STOCHcontentPanel(props) {
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    onChange ={(e,selectedOption) => {
                        props.nForSTOCHdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
        <Grid.Row>
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    compact
                    onChange ={(e,selectedOption) => {
                        props.dnForSTOCHdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
...
const mapDispatchToProps = dispatch => {
  return {
    nForSTOCHdispatch: x => dispatch(nForSTOCH(x)),
    dnForSTOCHdispatch: x => dispatch(dnForSTOCH(x)),
  }
}
