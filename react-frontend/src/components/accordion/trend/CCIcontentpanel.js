...
import { nForCCI, cForCCI } from '../../../redux'
import { Grid, Form, Select} from "semantic-ui-react"

function CCIcontentPanel(props) {
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    onChange ={(e,selectedOption) => {
                        props.nForCCIdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
        <Grid.Row>
            ...
            <Grid.Column width={4}>
                <Form.Input
                    ...
                    compact
                    onChange ={(e,data) => {
                        props.cForCCIdispatch(data.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
...
const mapDispatchToProps = dispatch => {
  return {
    nForCCIdispatch: x => dispatch(nForCCI(x)),
    cForCCIdispatch: x => dispatch(cForCCI(x)),
  }
}
