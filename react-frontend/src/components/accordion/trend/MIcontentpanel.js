...
import { nForMI, n2ForMI } from '../../../redux'
import { Grid, Form, Select} from "semantic-ui-react"

function MIcontentPanel(props) {
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    onChange ={(e,selectedOption) => {
                        props.nForMIdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
        <Grid.Row>
            ...
            <Grid.Column width={4}>
                <Form.Field
                    ...
                    compact
                    onChange ={(e,selectedOption) => {
                        props.n2ForMIdispatch(selectedOption.value)
                        }}
                />
            </Grid.Column>
        </Grid.Row>
...
const mapDispatchToProps = dispatch => {
  return {
    nForMIdispatch: x => dispatch(nForMI(x)),
    n2ForMIdispatch: x => dispatch(n2ForMI(x)),
  }
}
