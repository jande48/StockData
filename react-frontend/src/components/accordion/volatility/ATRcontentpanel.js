...
import { nForATR } from '../../../redux'
import { Grid, Menu, Form, Select} from "semantic-ui-react"

function ATRcontentPanel(props) {
  ...
  const nclass = new createTiles('Period (n):','14',props.nForATRdispatch)
...
const mapDispatchToProps = dispatch => {
  return {
    nForATRdispatch: x => dispatch(nForATR(x)),
